 ...
 let userData = JSON.parse(localStorage.getItem('userData'))
  return (
    <div>
        ...
        {userData == 'empty' ? <p className='underline underline-offset-4 text-slate-gray font-montserrat border-coral-red pt-[100px] text-center text-sm p-2'>{'Save your favorite items by '}  
